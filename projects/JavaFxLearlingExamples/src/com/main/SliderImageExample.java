...
public class SliderImageExample {
    ...
    final static Color textColor = Color.DARKGREY;
    final static SepiaTone sepiaEffect = new SepiaTone();

    public void sliderExampleImage() {
        try {
            ...
            grid.setVgap(10);
            grid.setHgap(70);
            FileInputStream input = new FileInputStream("images/cappuccino.jpg");
