...
$(document).ready(() => {
  ...
  $("#saveCategori").click(function () {
    ...
    var y = { id: kategoriyaList.length + 1, kategoriyaName: x }
  ...
  $("#saveTask").click(function () {
   ...
   var obyekt={id:taskList.length+1,task:tas,timefinish:day,timestart:clockString,kategoriya:kategoriya,status:false}
  ...
  $('#taskInput').on('input', function () {
    ...
    if (x.length < 2) { ; err = "Tapsirig minimum 2 simvol olmalıdır."; errB = false; kategoryaB = false; }
    if (x.length == 0) { ; err = "Tapsirigi boş qoymaq olmaz"; errB = false; kategoryaB = false; };
    if (x.length > 50) { ; err = "Tapsirig maksimum 50 simvol olmalıdır."; errB = false; kategoryaB = false; }
    if (errB) {
  ...
  $('#kategoriyaInput').on('input', function () {
    ...
    if (x.length < 2) { ; err = "Kategoriyani minimum 2 simvol olmalıdır."; errB = false; kategoryaB = false; }
    if (x.length == 0) { ; err = "Kategoriyani boş qoymaq olmaz"; errB = false; kategoryaB = false; };
    if (x.length > 20) { ; err = "Kategoriya maksimum 20 simvol olmalıdır."; errB = false; kategoryaB = false; }
    if (errB) {
  ...
  $('#lastDayInput').on('input', function () {
    ...
    if (x == "") { err = "Ne vaxt bitecegine bos qoymaq olmaz"; errB = false; }
